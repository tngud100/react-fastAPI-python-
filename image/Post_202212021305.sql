INSERT INTO jaylog.Post (title,thumbnail,content,summary,user_idx,create_date,update_date,delete_date) VALUES
	 ('(번역) 가장 빠른 자바스크립트 프레임워크','https://velog.velcdn.com/images/sehyunny/post/e48644e2-add4-44da-905c-b36a278d9d8f/image.png','![image](https://velog.velcdn.com/images/sehyunny/post/e48644e2-add4-44da-905c-b36a278d9d8f/image.png)
...
우리는 지금부터 "Qwik" 에 대해 이야기하려고 합니다. Qwik은 크기와 복잡성에 상관없이 즉시 로딩되는 애플리케이션을 제공하고, 규모에 맞게 일관된 성능을 달성할 수 있는 새로운 종류의 웹 프레임워크입니다.
',1,'2022-12-02 13:00:48',NULL,NULL),
	 ('React Rendering Optimization','https://velog.velcdn.com/images/hyunjine/post/16b2aa12-7e9e-49ea-b759-0544fbcfc626/image.png','![image](https://velog.velcdn.com/images/hyunjine/post/16b2aa12-7e9e-49ea-b759-0544fbcfc626/image.png)
...
React에서 함수나 값을 최적화하기 위해 useMemo, useCallback을 활용해보신 경험이 있으실 것입니다. 이 글에서는 useMemo와 useCallback이 React에 존재하는 이유와 이를 사용해야하는 상황에 대하여 알아보고 대다수의 경우에 useMem',1,'2022-12-02 13:00:48',NULL,NULL),
	 ('Next.js 13 정리','https://velog.velcdn.com/images/yoosion030/post/2544cc56-49bf-4df7-87c7-013b7d998d73/image.jpeg','![image](https://velog.velcdn.com/images/yoosion030/post/2544cc56-49bf-4df7-87c7-013b7d998d73/image.jpeg)
...
',1,'2022-12-02 13:00:48',NULL,NULL),
	 ('우테코 회고',NULL,'예상보다 조금 빠르게 우테코를 떠나게 됐다. 우테코 과정을 되돌아보고 잘했던 것과 못했던 것들을 짚어보면 새로운 시작에도 도움이 될 것 같다.
...
처음에는 카드 뉴스를 만드는 것이 사소한 일이라 생각했고, 그리 정성 들이지 않았다. 하지만 그런 태도를 갖고 맡은 일을 하니 금방 티가 났다. 조금만 신경 썼으면 고칠 수 있었던 것들을 고치지 않은 채 결과물이라고 갖고 가서 피드백을 받았을 때 많이 부끄러웠다. 크루들 중에는 같은 일을 맡더라도 꼼꼼하게 확인하고 퀄리티를 높여서 가져오는 크루들이 있었는데, 내가 관리자라면 그런 친구들이랑 일하고 싶겠다라는 생각을 했다.','예상보다 조금 빠르게 우테코를 떠나게 됐다. 우테코 과정을 되돌아보고 잘했던 것과 못했던 것들을 짚어보면 새로운 시작에도 도움이 될 것 같다.

딱 작년 이맘때 쯤 우테코에 지원을 했고 우테코에 합격하고 나서도 갈지 말지 되게 고민을 많이 했다. 취업을 목적으로 하던 공',1,'2022-12-02 13:00:48',NULL,NULL),
	 ('질문 잘하는 법','https://velog.velcdn.com/images/hamham/post/105cc93b-03cf-4cc0-8f1b-6f1768e66e20/image.PNG','# 개요
...
그래서 과연 코치님이 언급하신 ''질문을 잘하는'' 법이 어떤 것인지 궁금해지기 시작했고, 첨부된 하나의 영상과 다른 하나의 글을 보고 정리해보기로 했다.',' 개요
우아한테크코스 5기 프리코스 슬랙에서 코치님이 질문 잘하는 법에 대한 글과 유튜브 URL을 올려주셨다.
...
그',1,'2022-12-02 13:00:48',NULL,NULL),
	 ('나의 첫 스타트업 후기','https://velog.velcdn.com/images/maketheworldwise/post/2250e842-d29b-442b-90aa-3398e2ec4d78/image.gif','![image](https://velog.velcdn.com/images/maketheworldwise/post/2250e842-d29b-442b-90aa-3398e2ec4d78/image.gif)
...
내가 즐겨보았던 드라마중 하나는 바로 ''스타트업''이다. 회사와 성장하는 이야기를 그린 드라마이고 그 과정에서 발생하는 여러 문제들을 해결해나가는 부분이 낭만있다고 생각했다. 또한 드라마를 보면서 한번도 들어보지 못한 생소한 단어들이 등장하는데, 개발 용어만 공부하던 나에게 있어서 설렘을 부여해줬다. (수지짱...👍)','
 ...
 이 글의 목적?
최근에 이력서와 포트폴리오를 쓰느라 블로그 운영에 신경을 못썼다. 비록 같은 분야는 아니지만 그 동안 해왔던 내용들을 모두 정리하려다보니 어느새 너무 시간이 많이 지나버렸다. 그래서 다시 블로그를 활성화시킬겸 시간이 많이 지났지만 스타트업을 다녔던 ',1,'2022-12-02 13:00:48',NULL,NULL),
	 ('최신 Chrome 브라우저 렌더링 방식을 알아보자!','https://velog.velcdn.com/images/himprover/post/3a33709a-0048-49f3-8c99-bc8676ebb458/image.png','![image](https://velog.velcdn.com/images/himprover/post/3a33709a-0048-49f3-8c99-bc8676ebb458/image.png)
...
프론트엔드 면접 질문 하면 빠지지 않는 단골 주제는 바로 브라우저의 렌더링 방식 이라고 할 수 있다.
아마 이 글을 보게',1,'2022-12-02 13:00:48',NULL,NULL),
	 ('veltrends 개발 후기','https://velog.velcdn.com/images/velopert/post/043d71d9-5a66-4795-b960-ba7ff9384947/image.png','![image](https://velog.velcdn.com/images/velopert/post/043d71d9-5a66-4795-b960-ba7ff9384947/image.png)
...
이 포스트에서는 이 프로젝트를 만들면서 했던 생각들을 여러분들께 공유해보고자 합니다.
 ...
 프로젝트를 만든 이유
이 프로젝트를 시작한 주요 목적은 ',1,'2022-12-02 13:00:48',NULL,NULL),
	 ('[번역] Node.js 개요: 아키텍처, API, 이벤트 루프, 동시성','https://velog.velcdn.com/images/cookie004/post/2f15a09c-ab91-4964-a385-96eb1ec9eeda/image.png','![image](https://velog.velcdn.com/images/cookie004/post/2f15a09c-ab91-4964-a385-96eb1ec9eeda/image.png)
...
4.2.1 실행을 완료하면 코드가 더 간단해집니다
4.2.2 Node.js 코드가',2,'2022-12-02 13:00:48',NULL,NULL);
